    ...
    <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-white">
      ...
      <div className="relative h-64 md:h-80 bg-gradient-to-r from-blue-600 to-purple-600 overflow-hidden">
        <div 
          ...
          style={{
            backgroundImage: 'url(https://images.pexels.com/photos/6956892/pexels-photo-6956892.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2)',
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          <div className="bg-white rounded-xl shadow-lg p-8 border border-neutral-200">
            ...
            <p className="text-neutral-700 mb-4">
              Teen Phoenicians Magazine is a monthly digital publication created by teens, for teens. Each issue focuses on different aspects of mental health and wellbeing, featuring personal stories, expert advice, and practical resources.
            </p>
            <p className="text-neutral-700">
              Our magazine is completely free and can be viewed online or downloaded as a PDF. If you'd like to contribute to future issues with your story, artwork, or article, please reach out to us through the <a href="/feedback" className="text-blue-600 hover:text-blue-700 underline">Feedback page</a>.
            </p>
          </div>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-lg text-neutral-700 mb-6">
                  Our inaugural issue is here! Featuring teen stories, mental health resources, and expert insights for National Suicide Prevention Month & National Recovery Month.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
                ...
                >
                  ...
                  {showFlipHTML ? 'Hide' : 'Read'} FlipHTML Version
                </button>
              ...
              {showFlipHTML && (
                <div className="mt-6 transition-all duration-300">
                  <div className="bg-white rounded-lg p-4 shadow-xl border border-neutral-200">
                    <iframe
            src="https://flipbookpdf.net/web/site/73837085fffffb5ec4b38cb9b8c77ac56fb1f954202510.pdf.html"
        ...
        {/* Coming Soon - PFLY VOL I(B) - Smaller */}
        <div className="mb-16">
        ...
        <div className="text-center">
          <div className="bg-white rounded-xl shadow-lg p-8 max-w-2xl mx-auto border border-neutral-200">
            ...
            <p className="text-neutral-600 mb-6">
              Follow our journey and be the first to know when new issues launch. 
              We'll also share behind-the-scenes content and updates about upcoming magazines.
            </p>
